...
int ei_main (int argc, char *argv[]) {
    ...
    toplevel->configure(&window_size, &window_color, &window_border_width, &window_title, &closable, &window_resizable,
                        NULL);
    
    Button *button_ok = new Button(toplevel);
    button_ok->configure(&button_size, &button_color, &button_border_width, NULL, &relief, &button_title_ok, NULL,
                         &text_color, NULL, NULL, NULL, NULL);
    
    Button *button_cancel = new Button(toplevel);
    button_cancel->configure(&button_size, &button_color, &button_border_width, NULL, &relief, &button_title_cancel,
                             NULL, &text_color, NULL, NULL, NULL, NULL);
    
    Button *button_cut = new Button(toplevel);
    button_cut->configure(&button_size, &button_color, &button_border_width, NULL, &relief, &button_title_cut, NULL,
                          &text_color, NULL, NULL, NULL, NULL);
    ...
    p2->configure(button_ok, &button_anchor, &button_x, &button_y, NULL, NULL, &button_rel_x, &button_rel_y,
